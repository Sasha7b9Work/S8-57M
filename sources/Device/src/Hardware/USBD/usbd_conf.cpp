...
//        if (CABLE_USB_IS_CONNECTED)                               //
        {                                                           //
            if (prevLength != 0)                                    //
            {                                                       //
                VCP::cable_connected = true;                    // Ёто потому, что при включении прибора с подключенным шнуром
                VCP::client_connected = true;                         // GOVNOCODE “аким вот замысловатым образом определ€ем, что к нам подконнектилс€ хост (
            }                                                       //
            else                                                    //
            {                                                       //
