...
{
    if(((HCD_HandleTypeDef *)HAL_HCD::handleHCD)->hc[pipe].ep_is_in)
    {
        ((HCD_HandleTypeDef *)HAL_HCD::handleHCD)->hc[pipe].toggle_in = toggle;
    }
    else
    {
        ((HCD_HandleTypeDef *)HAL_HCD::handleHCD)->hc[pipe].toggle_out = toggle;
    }
...
uint8_t USBH_LL_GetToggle(USBH_HandleTypeDef *, uint8_t pipe)   
{
    ...
    if(((HCD_HandleTypeDef *)HAL_HCD::handleHCD)->hc[pipe].ep_is_in)
    {
        toggle = ((HCD_HandleTypeDef *)HAL_HCD::handleHCD)->hc[pipe].toggle_in;
    }
    else
    {
        toggle = ((HCD_HandleTypeDef *)HAL_HCD::handleHCD)->hc[pipe].toggle_out;
    }
