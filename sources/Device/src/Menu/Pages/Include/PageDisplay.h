...
struct ENumAverage
{
#define S_OSCI_ENUM_AVERAGE         (set.disp.enumAverage)
...
#define S_DISP_ENUM_ACCUM_IS_INFINITY   (set.disp.enumAccum == ENumAccum::_Infinity)
...
{ //-V802
    ...
    Ch::E                  lastAffectedChannel;     // \brief Последний управляемый канал. Используется для правильного вывода сигналов
