...
{
    Char(SymbolUGO2::MATH_FUNC_MUL, TypeFont::UGO, 4).Draw(x + 4, y + 3);
}
...
DEF_PAGE_5( pMath,                                                                                                                                         //--- СЕРВИС - ФУНКЦИЯ ---
    ...
    &bRangeA,
    &bRangeB,
    PageName::Math, &PageMeasures::self, IsActive_Math, Page::NormalTitle, OnOpenClose_Math, HandlerKey_Function
)
