...
struct DataSettings
{
    ...
    uint8       *ch_a;              // По этому адресу хранятся данные 1-го канала
    uint8       *ch_b;              // По этому адресу хранятся данные 2-го канала. При хранение в Buffer данные 2-го канала идут сразу после 1-го канала
    int16       rShift[2];
    int16       trigLev[2];
