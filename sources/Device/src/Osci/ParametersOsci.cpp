...
void TBase::Set(TBase::E base)
{
    ...
    static const uint8 values[TBase::Count] =
    {
        ...
        BIN_U8(00000000),   // 200ns   2       100MHz
        BIN_U8(00100000),   // 500ns   5       40MHz
        BIN_U8(00100001),   // 1us     10      20MHz
        BIN_U8(00100010),   // 2us     20      10MHz
        BIN_U8(00100101),   // 5us     50      4MHz
        BIN_U8(00100110),   // 10us    100     2MHz
        BIN_U8(00100111),   // 20us    200     1MHz
        BIN_U8(00101001),   // 50us    500     400kHz
        BIN_U8(00101010),   // 100us   1k      200kHz
        BIN_U8(00101011),   // 200us   2k      100kHz
        BIN_U8(00101101),   // 500us   5k      40kHz
        BIN_U8(00101110),   // 1ms     10k     20kHz
        BIN_U8(00101111),   // 2ms     20k     10kHz
        BIN_U8(00110001),   // 5ms     50k     4kHz
        BIN_U8(00110010),   // 10ms    100k    2kHz
        BIN_U8(00110011),   // 20ms    200k    1kHz
        BIN_U8(00110101),   // 50ms    500k    400Hz
        BIN_U8(00110110),   // 100ms   1M      200Hz
        BIN_U8(00110111),   // 200ms   2M      100Hz
        BIN_U8(00111001),   // 500ms   5M      40Hz
        BIN_U8(00111010),   // 1s      10M     20Hz
        BIN_U8(00111011),   // 2s      20M     10Hz
        BIN_U8(00111101),   // 5s      50M     4Hz
        BIN_U8(00111110)    // 10s     100M    2Hz
    };
